  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: 'background.default' }}>
      <Card sx={{ width: 400, maxWidth: '90vw' }}>
        <CardContent>
          <Stack spacing={2}>
            <Typography variant="h5" component="h1" textAlign="center" fontWeight={600}>VetPMS</Typography>
            <Typography variant="body2" textAlign="center" color="text.secondary">Veterinary Practice Management</Typography>
            <Alert severity="info" variant="outlined">Dev mode — enter any email/password to sign in.</Alert>
